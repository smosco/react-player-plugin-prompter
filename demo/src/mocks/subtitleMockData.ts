...
const subtitles: Subtitle[] = [
  {
    startTimeInSecond: 28.21,
    durationInSecond: 1.112,
    ko: '왜 그럴까요?',
    en: 'And why is that?',
    fr: 'Et pourquoi est-ce ainsi ?',
  },
  {
    startTimeInSecond: 29.346,
    durationInSecond: 3.766,
  ...
  {
    startTimeInSecond: 33.485,
    durationInSecond: 4.181,
  ...
  {
    startTimeInSecond: 37.69,
    durationInSecond: 3.73,
  ...
  {
    startTimeInSecond: 41.444,
    durationInSecond: 7.664,
  ...
  {
    startTimeInSecond: 61.771,
    durationInSecond: 1.72,
    ko: '두 번째, 판단.',
    en: 'Second, judging.',
    fr: 'Deuxièmement, le jugement.',
  },
  {
    startTimeInSecond: 63.515,
    durationInSecond: 8.49,
